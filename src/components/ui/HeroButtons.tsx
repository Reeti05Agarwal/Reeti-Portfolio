  ...
  return (
    <div className="flex flex-wrap gap-3 pt-6 items-center">
      <div className="flex gap-5">
        <a 
          href="#contact" 
          className="cyber-card px-5 py-2.5 rounded-lg text-cyan-400 hover:text-cyan-300 transition-colors font-mono text-xs sm:text-sm hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] flex items-center gap-2"
        >
          Get In Touch
        </a>
        <a 
