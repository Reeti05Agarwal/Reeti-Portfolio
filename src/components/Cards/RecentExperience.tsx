      ...
      <div className="space-y-6 border-l-4 border-blue-300/30 pl-6 relative">
        {recentExp.map((exp, idx) => (
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="flex flex-col justify-between bg-black/50 border border-white/10 backdrop-blur-xl rounded-2xl p-6 shadow-md transition-all duration-300 hover:shadow-lg hover:shadow-green-400/10 hover:border-green-400/30 "
            >
                {/* TIMELINE DOT */}
